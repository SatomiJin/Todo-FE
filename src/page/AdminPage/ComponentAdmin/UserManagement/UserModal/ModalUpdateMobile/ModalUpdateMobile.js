...
import "./ModalUpdateMobile.scss";
function ModalUpdateMobile(props) {
  ...
  return (
    <div className="modal-update-mobile">
      <div
        className="modal fade"
        id="updateUserModalMobile"
        tabIndex="-1"
        aria-labelledby="updateUserModalMobileLable"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="updateUserModalMobileLable">
...
export default ModalUpdateMobile;
